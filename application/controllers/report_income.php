...
class Report_income extends MY_Controller {
	...
	public function __construct()
	{
		...
		$this->data['breadcrumb'] = '
			...
			<li><a href="'.base_url($this->data['controller']).'">Laporan Pendapatan</a></li>
		';
	}
	...
	public function reports()
	{
		if($this->data['user_access_read']==true){
			...
			$this->data['order_lists'] = $this->call_sp("sel_ORDERS", array(0,0,"",""));
			$this->data['operational_cost_lists'] = $this->call_sp("sel_OPERATIONAL_COSTS", array(0,0,"",""));
			$this->data['title'] = "Laporan Pendapatan";
